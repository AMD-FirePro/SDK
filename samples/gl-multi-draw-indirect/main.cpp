...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(amd::DATA_DIRECTORY +"multi-draw-indirect.vert");
	std::string const FRAG_SHADER_SOURCE(amd::DATA_DIRECTORY + "multi-draw-indirect.frag");
