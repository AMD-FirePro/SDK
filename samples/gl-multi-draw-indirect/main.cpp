...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY +"multi-draw-indirect.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "multi-draw-indirect.frag");
